...
class FakeStoreProductRetrieveUpdateDestroyAPIView(CreateModelMixin, generics.RetrieveUpdateDestroyAPIView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        print(product_id)
        if not product_id:
            return Response({"detail": "productservice not found."}, status=404)
        try:
    ...
    def delete(self, request, *args, **kwargs):
        ...
        if delete_products:
            ...
            # If we want to return the deleted productservice data, ensure the productservice object is serialized
